      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/2 px-4 order-last lg:order-first">
            <img
              className="block max-w-lg mx-auto lg:max-w-none h-full w-full rounded-3xl object-cover"
              src="/map.jpg"
              alt=""
            />
          </div>
          <div className="w-full lg:w-1/2 px-4">
            <div className="max-w-lg mx-auto lg:mr-0 pt-14 pb-16 lg:py-24">
              <h1 className="font-heading text-6xl font-light tracking-tighter text-white mb-8">
                Let&#39;s talk
              </h1>
              <p className="text-base font-thin text-gray-500 mb-16">
                If you have any questions, inquiries, or would like to
                collaborate with us, we would love to hear from you. Please feel
              ...
              <div className="sm:flex mb-10">
                ...
                <div className="mt-6 sm:mt-0 sm:ml-6">
                  <span className="block text-white text-base font-thin mb-2">
                    Chat to us
                  </span>
                  <p className="text-base text-gray-500 font-thin mb-1">
              ...
              <div className="sm:flex mb-10">
                ...
                <div className="mt-6 sm:mt-0 sm:ml-6">
                  <span className="block text-white text-base font-light mb-2">
                    Call us
                  </span>
                  <p className="text-base font-thin text-gray-500 mb-1">
                    Lorem Ipsum is simply dummy text of the
                  </p>
                  <span className="text-base font-thin text-white">
                    +48 291 821 114
              ...
              <div className="sm:flex">
                ...
                <div className="mt-6 sm:mt-0 sm:ml-6">
                  ...
                  <span className="block mb-0.5 text-base font-thin text-white">
